    ...
    <div className="row_register">
      <div className="column_register">
        ...
        <div className="tp_register">
          <input className="check_register" type="checkbox"></input>
          I agree to the KUlony <p className={`link_register`} onClick={display_terms}>term of service</p>
        </div>
        <button className="button_register" onClick={display_verify}>SIGN UP</button>   
