...
function PostreportAdmin() {
  ...
  // const genpost = (e) => {
  //   axios
  //     .get(`https://kulony-backend.herokuapp.com/api/post/${e}`, {
  //       headers: {
  ...
  const gendata = () => {
    setPostiddata([])
    axios
      .get(`https://kulony-backend.herokuapp.com/api/admin/get_post_report`, {
        headers: {
  ...
  const discarddata = () => {
    axios
      .delete(`https://kulony-backend.herokuapp.com/api/admin/delete_report/{report_id}`, {
        headers: {
          Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InBhcmFtZWVub25AZ21haWwuY29tIiwiaWQiOiI2MzQ1NzY3ZjJiOTVlZTlmOWMwYTY2M2QiLCJ2ZXJpZmllZCI6dHJ1ZSwiaWF0IjoxNjY4MDU4NzY3LCJleHAiOjE2NjgxNDUxNjd9.NJQU4HZ6PGXYigF-G3P5B0-zieqjl4y4jWq4qUMovG8`,
        },
      })
  ...
  const deletedata = () => {
    axios
      .delete(`https://kulony-backend.herokuapp.com/api/admin/delete_reported_entity/{report_id}`, {
        headers: {
          Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InBhcmFtZWVub25AZ21haWwuY29tIiwiaWQiOiI2MzQ1NzY3ZjJiOTVlZTlmOWMwYTY2M2QiLCJ2ZXJpZmllZCI6dHJ1ZSwiaWF0IjoxNjY4MDU4NzY3LCJleHAiOjE2NjgxNDUxNjd9.NJQU4HZ6PGXYigF-G3P5B0-zieqjl4y4jWq4qUMovG8`,
        },
      })
